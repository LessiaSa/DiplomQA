...
### - Работа с новостями:
  ...
  #### - фильтрация новостей на странице "Новости":
   ...
   - фильтрация новостей по категории (кейсы 14, с 16 по 29 кроме кейса 23);
  ...
  #### - работа во вкладке "Создание новости" страницы "Панель управления":
   ...
   - работа с полем "Категория" (кейсы с 56 по 65, кейс 79),
   - работа с полем "Заголовок" (кейсы 66 и 81),
   - работа с полем "Дата публикации" (кейс 67),
   - работа с полем "Время" (кейсы 69, 71, 72 и с 75 по 77),
...
### - Burger menu приложения:
  ...
  - переход на страницы с помощью Burger menu со страницы "Новости" (кейс 126).
...
- поле "Категория"(кейс 55),
- выбор датой публикации прошедшую дату (кейс 68),
- кручение стрелок для выбора времени публикации(кейс 70),
...
- переход на страницу с информацией о приложении с помощью Burger menu на App bar страницы "Новости(кейс 127),
